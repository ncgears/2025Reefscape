...
public class ElevatorConstants {
    ...
    public static final double kMagnetOffset = -0.098877; //Adjust magnet to sensor offset for CANcoder
    ...
    public static final double kP = 15.0; // add kP per rotation of error: error of 1 rotation results in 12v output (this might be low for aimer)
