...
public class ElevatorConstants {
    ...
    public static final double kMagnetOffset = -0.260742; //Adjust magnet to sensor offset for CANcoder
    ...
    //PID Control
    public static final double kS = 0.15; //0.34327; // add kS to overcome static friction: adjust first to start moving
    ...
    */
    ...
    public class Positions {
        ...
        public static final double kAlgaeHigh = 3.4; //Elevator between L3 and L4
        ...
        public static final double kAlgaeLow = 2.1; //Elevator between L2 and L3
